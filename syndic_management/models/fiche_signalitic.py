...
class Desamientage(models.Model):
    ...
    desamiente_par = fields.Many2one('syndic.supplier', string=u'Désamianté par')
...
class SignalitiqueImmeuble(models.Model):
    ...
    chauffage = fields.Many2one('syndic.supplier', u'Expert chauffage')
    ...
    ascensseur_par = fields.Many2one('syndic.supplier', u'Executé par')
    ...
    access_where = fields.Many2one('syndic.supplier', u'Certificat pour la reproduction de clé')
    access_more = fields.Text('Informations et descriptions')

    # parlophone et boite
    plaquette_supplier = fields.Many2one('syndic.supplier', u'Société de plaquettes')
    ...
    entr_control = fields.Many2one('syndic.supplier', u'Société de contrôle')
    ascensseur_more = fields.Text(u'Observation complémentaires')

    # compteur
    societe_compteur = fields.Many2one('syndic.supplier', u'Société')
    ...
    elec_building = fields.Many2one('syndic.supplier', u'electricien du bâtiment')
